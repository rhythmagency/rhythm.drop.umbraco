...
/// <summary>
/// A collection of methods to augment <see cref="MapperContext"/> to map to collections of <see cref="IModal"/> objects.
/// </summary>
public static class MapperContextModalsExtensions
{
    /// <summary>
    ...
    /// </returns>
    public static TModal[] MapModals<TModal>(this MapperContext mapperContext, BlockListModel? list) where TModal : class, IModal
    {
        if (list is null)
        {
            return [];
    ...
    /// <para>This method will return an empty collection if <paramref name="list"/> is <see langword="null"/>.</para>
    /// </returns>
    public static IModal[] MapModals(this MapperContext mapperContext, BlockListModel? list)
    {
        return mapperContext.MapModals<IModal>(list);
    }
}