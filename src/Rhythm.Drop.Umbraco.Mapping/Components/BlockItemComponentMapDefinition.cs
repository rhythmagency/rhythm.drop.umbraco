...
public abstract class BlockItemComponentMapDefinition<TBlockContent> : BlockItemComponentMapDefinition<TBlockContent, IComponent> where TBlockContent : IPublishedElement
{
    /// <inheritdoc/>
...
public abstract class BlockItemComponentMapDefinition<TBlockContent, TComponent> : IComponentMapDefinition where TComponent : class, IComponent where TBlockContent : IPublishedElement
{
    /// <inheritdoc/>
